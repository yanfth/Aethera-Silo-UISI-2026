    ...
    <div className={styles.container}>
      ...
      <footer className={styles.footer}>
        ...
        <div>
          ...
          <div className={styles.footerLinks}>
            <a
              href="https://www.instagram.com/silouisi2026?igsh=MThqZ2Z1YXAzcng1ZA=="
              target="_blank"
              rel="noopener noreferrer"
            >
              Instagram
            ...
            <a
              href="https://www.tiktok.com/@branarasilouisi2025?_r=1&_t=ZS-98iD5zNgHEi"
              target="_blank"
              rel="noopener noreferrer"
            >
              TikTok
            ...
            <a
              href="https://wa.me/6289667151265"
              target="_blank"
              rel="noopener noreferrer"
            >
              WhatsApp
